...
const OnboardingScreen = ( { navigation }: any ) => {
    ...
    return (
        <View style={ styles.container }>
            ...
            <View style={ styles.dotsContainer }>
                { slides.map( ( _, index ) => (
                    <View
                        ...
                        style={ [
                            styles.dot,
                            { opacity: index === currentIndex ? 1 : 0.3, width: index === currentIndex ? 20 :8 },
                        ] }
                    />
                ) ) }
            </View>
            ...
            <CustomButton title={ currentIndex === slides.length - 1 ? otherStrings.getStarted : otherStrings.next } onPress={ handleNext }/>
            </View>
        </View>
    );
};

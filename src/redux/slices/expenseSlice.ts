/**
 * @file src/redux/slices/expenseSlice.ts
 * @description Redux state management logic (slice/store/selectors).
 * @lastUpdated 2025-09-19T11:33:09.025Z
 */
...
>('expenses/fetch', async (params, { rejectWithValue }) => {
  try {
...
export const fetchExpenseDetails = createAsyncThunk<
  ...
  number, // ✅ args type
  { rejectValue: string }
>('expenses/fetchDetails', async (id, { rejectWithValue }) => {
  try {
